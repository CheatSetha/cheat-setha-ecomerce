...
const validationSchema = Yup.object({
	...
	password: Yup.string().min(8, "កាក​​ password ត្រូវតែចាប់ពី៨ខ្ទង់ឡើង").required("កាក​​ មិនអាចទទេបានទេ"),
	confirmPassword: Yup.string().oneOf([Yup.ref("password"), null], "កាក​​ password មិនត្រូវគ្នាទេ").required("កាក​​ មិនអាចទទេបានទេ"),
...
export default function page() {
	...
	const uploadImage = async (values) => {
		...
		try {
			...
			setIsLoading(false);
			return response.data.location || "https://www.pulsecarshalton.co.uk/wp-content/uploads/2016/08/jk-placeholder-image.jpg";
		} catch (error) {
			console.log(error);
		}
	}
	...
	return (
		...
		<div className='hero min-h-screen bg-base-200'>
			...
			<div className='hero-content flex-col lg:flex-row-reverse'>
				{isLoading ? <>
					<div className="w-full h-[100vh] bg-slate-900 absolute z-50 opacity-40" >
							...
							<Form>
								<div >
									...
									<Field type="text" name="name"
										...
										placeholder="បញ្ជូលឈ្មោះអ្នកប្រើប្រាស់" /> <br />
									...
									<Field type="email" name="email"
										className='input input-bordered my-3'
										placeholder="បញ្ជូល email អ្នកប្រើប្រាស់" /> <br />
									<ErrorMessage name="email" component="h1"
										className="text-red-500 text-xs italic"
									/>
									{/* password */}
									<label htmlFor="password"> បញ្ចូល password របស់អ្នក </label> <br />
									...
									/>
									{/* confirm password */}
									<label htmlFor="confirmPassword"> ផ្ទៀង password របស់អ្នក </label> <br />
									<Field type="password" name="confirmPassword"
										className='input input-bordered my-3'
										placeholder="បញ្ជូលឈ្មោះអ្នកប្រើប្រាស់" /> <br />
									<ErrorMessage name="confirmPassword" component="h1"
										className="text-red-500 text-xs italic"
									/>
									...
									/>
									<ErrorMessage name="file" component="h1"
										className="text-red-500 text-xs italic"
									/>
									<button type="submit" disabled={isSubmitting} className="btn btn-warning ">submit</button>
